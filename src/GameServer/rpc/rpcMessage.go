...
*/
func onRpcProcess(session akNet.TcpSession, req *MSG_Rpc.CS_Rpc_Req) (succ bool, err error) {
...
func init() {
	akNet.RegisterMessage(uint16(MSG_MainModule.MAINMSG_RPC), uint16(MSG_Rpc.SUBMSG_CS_Rpc), onRpcProcess)
}
